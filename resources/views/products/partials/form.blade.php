<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input type="text" name="sku" value="{{ old('sku', $product->sku ?? '') }}" class="w-full rounded-lg border border-gray-300 bg-gray-50 hover:bg-white focus:bg-white focus:outline-none focus:ring-0 focus:border-blue-500 transition-colors px-3 py-3" placeholder="SKU-000" required/>
          @error('sku')
        ...
        <div>
          ...
          <div class="relative">
            <input type="number" name="prix_achat" value="{{ old('prix_achat', $product->prix_achat ?? '') }}" step="0.01" class="w-full rounded-lg border border-gray-300 bg-gray-50 hover:bg-white focus:bg-white focus:outline-none focus:ring-0 focus:border-blue-500 transition-colors pl-10 pr-3 py-3" placeholder="0.00" required/>
       ...
       <div>
        ...
        <div>
          ...
          <div class="relative">
            <input type="number" name="quantite" value="{{ old('quantite', $product->quantite ?? '') }}" class="w-full rounded-lg border border-gray-300 bg-gray-50 hover:bg-white focus:bg-white focus:outline-none focus:ring-0 focus:border-blue-500 transition-colors pl-10 pr-3 py-3" placeholder="0" required/>
            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">pcs</span>
          </div>
          @error('quantite')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
          @enderror
        ...
        <div>
          ...
          <div class="relative">
            <input type="number" name="seuil_stock" value="{{ old('seuil_stock', $product->seuil_stock ?? '10') }}" class="w-full rounded-lg border border-gray-300 bg-gray-50 hover:bg-white focus:bg-white focus:outline-none focus:ring-0 focus:border-blue-500 transition-colors pl-10 pr-3 py-3" placeholder="10" required/>
            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">pcs</span>
          </div>
          @error('seuil_stock')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
